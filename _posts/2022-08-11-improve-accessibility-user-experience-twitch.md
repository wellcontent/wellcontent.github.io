---
layout: post
title: "How To Easily Improve Accessibility & User Experience On Twitch"
...
- [Chat Box Width](#chat-box-width)
- [Readable Chat Colors](#readable-chat-colors)
- [Filter Visual Elements](#filter-visual-elements)
- [Chat Pronouns](#chat-pronouns)
...
- [Bonus: Multi-Actions](#multi-actions)
...
But if you're like me, and your neurodivergent brain forgets to take *any* breaks in 4-hour streams, consider using automated ads. There's nothing wrong with using the ad scheduler. As long as your viewers know when they can expect ads. Communicate. They'll understand.
...
This means that an average of 1 in 3 people will leave before they even watch your stream. Especially if they're seeing your content for the first time. Or if a raid happens, and everyone coming in gets hit with ads first.
